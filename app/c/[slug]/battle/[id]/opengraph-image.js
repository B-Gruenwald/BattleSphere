...
// Auto-injected as og:image — shows attractively in Discord, Slack, iMessage, etc.
...
const RED_DIM    = 'rgba(180,30,30,0.18)';
...
export default async function OgImage({ params }) {
  ...
  if (!battle) {
    // Fallback: generic BattleSphere card
    return new ImageResponse(
      (
        <div style={{ width: 1200, height: 630, display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: BG_VOID, color: TEXT_PRI, fontFamily: 'serif' }}>
  ...
  const narrative      = battle.narrative ? trunc(battle.narrative, 120) : null;
  ...
  // Gold glow for the winning side
  const attackerGlow = attackerWon ? `0 0 40px ${attackerColour}55` : 'none';
  const defenderGlow = defenderWon ? `0 0 40px ${defenderColour}55` : 'none';
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          {/* Battle headline (if set) */}
          {headline && (
            <div
              style={{
                fontSize: headline.length > 40 ? 38 : 48,
                fontWeight: 900,
                letterSpacing: 3,
                textTransform: 'uppercase',
                color: TEXT_PRI,
          ...
          >
            ...
            >
              ...
              <div
                style={{
                  fontSize: attackerName.length > 18 ? 34 : 44,
                  fontWeight: 900,
                  letterSpacing: 2,
                  textTransform: 'uppercase',
                  color: TEXT_PRI,
              ...
              <div
                style={{
                  width: 48,
                  height: 3,
                  backgroundColor: attackerColour,
                  marginTop: 10,
                  opacity: 0.8,
                }}
              />
            ...
            >
              ...
              <div
                style={{
                  width: 16,
                  height: 16,
                  backgroundColor: isDraw ? TEXT_MUT : GOLD,
                  transform: 'rotate(45deg)',
                  margin: '10px 0',
                  opacity: isDraw ? 0.5 : 0.9,
                }}
              />
              {/* VS label */}
              <div
            ...
            >
              ...
              <div
                style={{
                  fontSize: defenderName.length > 18 ? 34 : 44,
                  fontWeight: 900,
                  letterSpacing: 2,
                  textTransform: 'uppercase',
                  color: TEXT_PRI,
              ...
              <div
                style={{
                  width: 48,
                  height: 3,
                  backgroundColor: defenderColour,
                  marginTop: 10,
                  opacity: 0.8,
                }}
              />
